...
class ListTileWithRadio extends StatefulWidget {
  final String title;

  const ListTileWithRadio({Key key, this.title}) : super(key: key);

  @override
  _ListTileWithRadioState createState() => _ListTileWithRadioState();
}

class _ListTileWithRadioState extends State<ListTileWithRadio> {
  answer _oilStatus = answer.no;
  @override
  Widget build(BuildContext context) {
    return Row(
